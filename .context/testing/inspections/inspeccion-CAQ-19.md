...
| :--- | :--- |
| Criterios y escenarios inspeccionados | `.context\PBI\epics\EPIC-CAQ-8-pagina-publica-y-auto-reserva\stories\STORY-CAQ-19-conflicto-de-reserva-concurrente\story.md` |
| Alcance funcional contrastado | `.context/architecture/prd.md` · Feature 3 |
| Reglas vigentes del release 1.1 | `.context/product-decisions/decisiones-po-proximo-release.md` · CAQ-19 y decisiones transversales aplicables |
